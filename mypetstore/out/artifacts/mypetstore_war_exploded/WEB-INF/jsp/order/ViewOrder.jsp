...
<div id="Content"><ul class="messages"><font color="green"> <li>Thank you, your order has been submitted.</li></font></ul>
	...
	<tr>
		...
		<table>
			...
			<c:forEach var="lineItem" items="${sessionScope.order.lineItems}">
				<tr>
					<td><a href="viewItem?itemId=${lineItem.item.itemId}">${lineItem.item.itemId}</a>
